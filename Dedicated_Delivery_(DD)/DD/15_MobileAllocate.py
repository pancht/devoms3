...
class B(unittest.TestCase):
    ...
    def test_b(self):
        ...
        time.sleep(5)
        driver.find_element_by_id("containers.license_plate").send_keys("LP-00031210" + Keys.ENTER)
        time.sleep(10)
        driver.get_screenshot_as_file("15_AllocateMobile.png")
...
if __name__ == "__main__":
    unittest.main(testRunner=HtmlTestRunner.HTMLTestRunner(output='Report_MobileAllocate'))