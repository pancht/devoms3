...
class B(unittest.TestCase):
    ...
    def test_b(self):
        ...
        time.sleep(5)
        driver.find_element_by_id("HAWB").send_keys("SSkm" + "H2" + Keys.ENTER)
        driver.find_element_by_id("inventory_bins.bin").send_keys("staging1" + Keys.ENTER)
        driver.find_element_by_id("dummy").send_keys("MLP-00000106" + Keys.ENTER)
        time.sleep(5)
        driver.get_screenshot_as_file("10_ScanLoad.png")
...
if __name__ == "__main__":
    unittest.main(testRunner=HtmlTestRunner.HTMLTestRunner(output='Report_scan'))