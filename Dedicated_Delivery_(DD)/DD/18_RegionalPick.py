...
class B(unittest.TestCase):
    ...
    def test_b(self):
        ...
        time.sleep(15)
        #LP
        driver.find_element_by_xpath("//*[@id='rf']/div/div[6]/input").send_keys("LP-00031210" + Keys.ENTER)
        time.sleep(20)
        #################################################################Se le suman 8 - RLLP
        driver.find_element_by_xpath("//*[@id='rf']/div/div[2]/input").send_keys("RLLP-00006918" + Keys.ENTER)
        time.sleep(10)
        #################################################################Se le suma 46 - SCC
        driver.find_element_by_xpath("//*[@id='rf']/div/div[5]/input").send_keys("212400000000318496" + Keys.ENTER)
        time.sleep(20)
        ...
        time.sleep(20)
        driver.get_screenshot_as_file("18_RegionalPick.png")
...
if __name__ == "__main__":
    unittest.main(testRunner=HtmlTestRunner.HTMLTestRunner(output='Report_RegionalPick'))